...
import time
import os
<<<<<<<< HEAD:electricity_usage/daemon.py
import subprocess
...
import em_data
#import client
>>>>>>>> 6add0a534604a868258e9dc85d5c60d554a61063:electricity_usage/daemon_blubb.py
import job
...
class Daemon:
    ...
    def __init__(self, area):
        if not hasattr(self, 'initialized'):
            ...
            self.observer.schedule(self.event_handler, path=sys.argv[1], recursive=False) #recursive
            self.observer.start()
...
========
        if estimate and deadline and commandline:# and area:
>>>>>>>> 6add0a534604a868258e9dc85d5c60d554a61063:electricity_usage/daemon_blubb.py
            with self.lock:
